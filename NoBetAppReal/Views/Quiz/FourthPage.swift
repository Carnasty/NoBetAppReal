...
struct FourthPage: View {
    ...
    @State private var goToFifthPage = false
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                        ...
                        HStack {
                            ZStack(alignment: .leading) {
                                ...
                                RoundedRectangle(cornerRadius: 8)
                                    ...
                                    .frame(width: (UIScreen.main.bounds.width - 48) * 0.25, height: 8) // 25% of available width
                            }
                    ...
                    if !viewModel.questions.isEmpty && viewModel.currentQuestionIndex < viewModel.questions.count {
                        let currentQuestion = viewModel.questions[1] // Use second question
                ...
                NavigationLink(destination: FifthPage(viewModel: viewModel).navigationBarHidden(true), isActive: $goToFifthPage) {
                    EmptyView()
                }
            }
        }
...
#Preview {
    FourthPage(viewModel: OnboardingViewModel())
} 
