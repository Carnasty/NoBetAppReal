...
struct SixthPage: View {
    ...
    @State private var goToSeventhPage = false
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                        ...
                        HStack {
                            ZStack(alignment: .leading) {
                                ...
                                RoundedRectangle(cornerRadius: 8)
                                    ...
                                    .frame(width: (UIScreen.main.bounds.width - 48) * 0.5, height: 8) // 50% of available width
                            }
                    ...
                    if !viewModel.questions.isEmpty && viewModel.currentQuestionIndex < viewModel.questions.count {
                        let currentQuestion = viewModel.questions[3] // Use fourth question
                ...
                // Navigation to SeventhPage
                NavigationLink(destination: SeventhPage(viewModel: viewModel).navigationBarHidden(true), isActive: $goToSeventhPage) {
                    EmptyView()
                }
            }
        }
...
#Preview {
    SixthPage(viewModel: OnboardingViewModel())
} 